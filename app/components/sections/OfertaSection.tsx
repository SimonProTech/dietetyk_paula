...
const OfertaSection = () => {
    ...
    return (
        <section className="relative mt-20">
            <span className="absolute right-10 bounce-down underline underline-offset-4 rotate-90 text-xl font-thin">
                Przewiń w dół
            </span>
            ...
            <div ref={sectionRef} className="relative w-full" style={{ height: `400vh` }}>
                ...
                <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center">
                    {/* Obrazek */}
                    <div className="w-full bg-no-repeat bg-center bg-contain h-[80vh] bg-[url('http://localhost:3000/assets/emojis/paula-with-laptop.png')] relative flex justify-center items-center" />
            ...
            <motion.div
                id="oferta"
                style={{ y: box }}
                className="absolute bg-gradient-to-b dark:from-black/0 dark:to-black from-[#efefef]/0 z-50 to-[#efefef] w-full h-[200vh]"
            ></motion.div>
            <div className="w-full mx-auto z-[99999] pl-5 pr-5 relative">
                <div
                    ref={bottomRef}
                    className="grid md:grid-cols-2 grid-cols-1 lg:container lg:pl-10 lg:pr-10 mx-auto gap-10"
                >
                    {ofertaStaticDb
                        .filter((x) => x.show)
                        .map((offer, index) => {
                            return (
                                <>
                                    ...
                                    >
                                        ...
                                        <div className="lg:p-6 p-4 flex min-[300px]:flex-row flex-col justify-between items-center w-full">
                                            <h2 className="xl:text-2xl text-[1.5rem] dark:text-white text-black font-bold text-textColor text-left">
                                                {offer.title}
                                            </h2>
                                            <span className="font-extrabold text-2xl w-max text-pink-600">
                                            ...
                                            offer.whatYouGet[0] === '' ? (
                                                ...
                                                offer.whatYouGet.map((item, index) => {
                                                    return (
                                                        ...
                                                        >
                                                            <HandHeart
                                                                className="text-pink-600 min-w-[23px]"
                                                                size={23}
                                                            />
                                        ...
                                        <span className="bg-pink-600 absolute right-0  min-[450px]:right-1 text-sm text-white font-bold rounded-md min-[450px]:px-2 px-1 py-1 min-[450px]:py-1 bottom-0 min-[450px]:bottom-1">
                                            Czytaj więcej
                                        </span>
                                    </MotionLink>
                                </>
